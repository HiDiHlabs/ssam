...
class SSAMAnalysis(object):
    ...
    def map_celltypes_aaec(self, n_celltypes=-1, X=None, labels=None, use_transferred_labels=False, unsupervised=False, weighted=False, min_norm=0, epochs=1000, n=1, seed=0, batch_size=1000):
        if not unsupervised:
            if labels is None:
